...
!function($) {
	...
	defaults = {
		sugClass: 'emailSug',
		domains: ['http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/163.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/126.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/sohu.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/139.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/sina.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/qq.com', 'http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/gmail.com']
	};
	...
	EmailSug.prototype = {
		...
		addEvent: function() {
			...
			this.$field.on('http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/keyup.ema',
			function(e) {
			...
			}).on('http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/blur.ema',
			function() {
				setTimeout(function() {
					that.hide();
				},
...
!(function($) {
	...
	$.fn.raty.defaults = {
		cancel: false,
		cancelHint: '取消评级!',
		cancelOff: 'cancel-off.png'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/cancel-off.png*/,
		cancelOn: 'cancel-on.png'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/cancel-on.png*/,
		cancelPlace: 'left',
		click: undefined,
		half: false,
		halfShow: true,
		...
		size: 16,
		space: true,
		starHalf: 'star-half.png'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/star-half.png*/,
		starOff: 'star-off.png'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/star-off.png*/,
		starOn: 'star-on.png'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/star-on.png*/,
		target: undefined,
		targetFormat: '{score}',
		targetKeep: false,
		targetText: '',
...
function($) {
	...
	if (!$.fn.tooltip) throw new Error('Popover requires tooltip.js'/*tpa=http://demo.h-ui.net/H-ui.admin.page/static/h-ui/js/Popover requires tooltip.js*/);
